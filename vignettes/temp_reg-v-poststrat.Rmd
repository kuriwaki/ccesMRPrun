...
Variables like party ID and religion are not available in the population target. O
...
## Extensions: Impute-Poststratify

We extend the ACS table assisted by a survey model. See [the function website](https://www.shirokuriwaki.com/ccesMRPprep/reference/impute_cells.html) for details.

```{r}
acs_synth <- impute_cells(educ ~ female + age,
                          microdata = cces_GA,
